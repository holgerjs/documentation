...
| Subnet Requirements               | Minimum /29              |None                           | Minimum /26   |
...
| Usage | SSH / RDP Cients | SSH / RDP (through Port forwarding) Clients | Primarily browser-based (HTML5), Using clients is possible with the Standard SKU |
